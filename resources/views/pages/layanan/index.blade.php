                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>Data Layanan</h4>
                            <a href="{{ route('layanan.create') }}" class="btn btn-primary btn-sm"><i
                                    class="fas fa-plus"></i>
                                Layanan</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('layanan.destroy', $item->id) }}" id="formDelete"
                                                    method="post" class="d-inline">
                                                    @csrf
                                                    @method('delete')
                                                    <button id="btnDelete"
                                                        data-action="{{ route('layanan.destroy', $item->id) }}"
